/-!
# schanuel-conjecture-canonical-lane Lean migration boundary
...
`SchanuelConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "schanuel-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/schanuel-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Schanuel's conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["mathematical-proof", "model-theory", "number-theory", "reproducibility", "exponential-algebra", "schanuel-conjecture", "transcendence-theory", "canonical-lane", "local-to-global", "manifold-constrained"]
